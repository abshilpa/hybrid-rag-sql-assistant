...
EVAL_SET = [
    ...
    {"q": "Which stores offer click and collect?", "route": "database", "doc": None,
     "reference": "A list of the participating stores that offer click and collect, for example Oxford Street, Westfield Stratford, Bullring, Manchester Arndale, Liverpool ONE, Leeds Trinity, Cabot Circus and Victoria Centre."},
    {"q": "Which promotions are active right now?", "route": "database", "doc": None,
     "reference": "A list of the currently active promotions with their discount percentages, for example Summer Sale (20% off), Members Exclusive (15% off), Nike Festival (20% off) and other promotions whose dates include today."},
